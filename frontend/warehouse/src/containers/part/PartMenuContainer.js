...
import { CREATE_PART } from '../../constants/url';
    ...
    <Grid.Row>
      <Grid.Column>
        <Menu stackable >
          ...
          <Menu.Item as={NavLink} name="createPart" to={CREATE_PART} onClick={(e, data) => { partCreationHandler(e, data) }}>Добавить запчасть</Menu.Item>
          <Menu.Item
            as={Button}
